 ...
 * =======================
 * Adjust the following to fit project structure and Supabase settings:
 *
 ...
 * - "default Pathnames": Can be customized to fit project structure.
 *
...
// Extract only the required types from EmailOtpType as used by this Auth Kit.
